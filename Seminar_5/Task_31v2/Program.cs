// Задача 31: Задайте массив из N элементов, заполненный случайными числами из промежутка  
...
// void FindSums(int[] array)   // дублирует FindSums2
// {
//     int sum_p = 0;
//     int sum_n = 0;
...
PrintArray(array);
// FindSums(array); // дублирует FindSums2
